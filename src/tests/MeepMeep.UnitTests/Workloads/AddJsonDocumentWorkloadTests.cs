...
namespace MeepMeep.UnitTests.Workloads
{
    ...
    {
        [Test]
        public async Task When_no_warmup_and_executed_with_10_documents_It_will_try_and_insert_10_docs()
        {
        ...
        [Test]
        public async Task When_no_warmup_and_executed_with_10_documents_It_will_generate_a_result_with_10_operation_results()
        {
            SUT = CreateWorkload(numOfDocs: 10, warmupMs: 0);
        ...
        [Test]
        public async Task When_no_warmup_and_exception_is_thrown_for_10_docs_by_the_client_It_will_generate_a_result_with_failed_operation_results()
        {
            SUT = CreateWorkload(numOfDocs: 10, warmupMs: 0);
